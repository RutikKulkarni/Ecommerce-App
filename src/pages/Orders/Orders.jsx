    ...
    <div className="container mx-auto p-4 md:p-8">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 border border-gray-200">
        ...
        <div className="space-y-2 mb-4">
          ...
          <p className="text-lg">
            <span className="font-medium text-gray-800">Mobile Number:</span> {order.mobile}
          </p>
          <p className="text-lg">
            <span className="font-medium text-gray-800">Address:</span> {order.address}
          </p>
          <p className="text-lg">
            <span className="font-medium text-gray-800">Total Amount:</span> ${order.total}
          </p>
          <p className="text-lg">
        ...
        <ul className="divide-y divide-gray-200">
          {order.items.map((item) => (
            <li key={item.id} className="py-4 flex flex-col md:flex-row md:justify-between">
              <div className="space-y-1">
                <p className="text-lg">
                  <span className="font-medium text-gray-800">Name:</span> {item.name}
                </p>
                <p className="text-lg">
                  <span className="font-medium text-gray-800">Price:</span> ${item.price}
                </p>
                <p className="text-lg">
